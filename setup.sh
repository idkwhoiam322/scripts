...
if [[ "$@" =~ "gcc" ]]; then
	...
	cd clang
	ls
	rm -rf clang-3289846 && rm -rf clang-4679922 && rm -rf clang-r328903 && rm -rf clang-r339409b && rm -rf clang-4679922 && rm -rf clang-3289846 && rm -rf clang-r328903 && rm -rf clang-r339409b && rm -rf clang-r344140b && rm -rf clang-r346389 && rm -rf clang-r346389b && rm -rf clang-r346389c && rm -rf clang-stable
	ls
	cd ..
fi
